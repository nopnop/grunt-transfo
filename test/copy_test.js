...
exports.copy = {
  main: function(test) {
    ...
    var actual = fs.readdirSync('tmp_copy/copy_test_files').sort();
    ...
    actual = fs.readdirSync('tmp_copy/copy_test_mix').sort();
    ...
    actual = fs.readdirSync('tmp_copy/copy_test_v0.1.0').sort();
  ...
  flatten: function(test) {
    ...
    var actual = fs.readdirSync('tmp_copy/copy_test_flatten').sort();
  ...
  single: function(test) {
    ...
    var actual = grunt.file.read('tmp_copy/single.js');
